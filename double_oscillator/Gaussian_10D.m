...
A = [[0.45 0.2 0 0 0 0 0 0 0 0];
    [0.2 0.45 0.2 0 0 0 0 0 0 0];
    [0 0.2 0.45 0.2 0 0 0 0 0 0];
    [0 0 0.2 0.45 0.2 0 0 0 0 0];
    [0 0 0 0.2 0.45 0.2 0 0 0 0];
    [0 0 0 0 0.2 0.45 0.2 0 0 0];
    [0 0 0 0 0 0.2 0.45 0.2 0 0];
    [0 0 0 0 0 0 0.2 0.45 0.2 0];
    [0 0 0 0 0 0 0 0.2 0.45 0.2];
    [0 0 0 0 0 0 0 0 0.2 0.45]];

B=[[0.35 0.35 0 0 0 0 0 0 0 0];
   [0.35 0.35 0.35 0 0 0 0 0 0 0];
   [0 0.35 0.35 0.35 0 0 0 0 0 0];
   [0 0 0.35 0.35 0.35 0 0 0 0 0];
   [0 0 0 0.35 0.35 0.35 0 0 0 0];
   [0 0 0 0 0.35 0.35 0.35 0 0 0];
   [0 0 0 0 0 0.35 0.35 0.35 0 0];
   [0 0 0 0 0 0 0.35 0.35 0.35 0];
   [0 0 0 0 0 0 0 0.35 0.35 0.35];
...
writematrix(cumreg_PSRL_LQ_ULA,['10d-regret' '.csv']);
writematrix(compute_time,['10d-time' '.csv']);
writematrix(step_iter,['10d-iter' '.csv']);
figure
hold on
x = 1:time_horizon;
